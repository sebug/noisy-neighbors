...
resource natNsg 'Microsoft.Network/networkSecurityGroups@2023-05-01' = {
  name: NATSubnetNSGName
  location: location
  properties: {}
}

resource hyperVNsg 'Microsoft.Network/networkSecurityGroups@2023-05-01' = {
  name: hyperVSubnetNSGName
  location: location
  properties: {}
}

resource ghostedNsg 'Microsoft.Network/networkSecurityGroups@2023-05-01' = {
  name: ghostedSubnetNSGName
  location: location
  properties: {}
}

resource azureVmsSubnet 'Microsoft.Network/networkSecurityGroups@2023-05-01' = {
...
resource hostVm 'Microsoft.Compute/virtualMachines@2023-07-01' = {
...
resource hostVmSetupExtension 'Microsoft.Compute/virtualMachines/extensions@2023-07-01' = {
  parent: hostVm
  name: 'HVHOSTSetup'
  location: location
  properties: {
